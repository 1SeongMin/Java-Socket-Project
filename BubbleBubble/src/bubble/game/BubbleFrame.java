...
public class BubbleFrame extends JFrame {
	...
	private void initSetting() {
		...
		//윗 줄
				...
				//아랫줄 
				JLabel player1_score = new JLabel("score1");
				...
				JLabel player2_score = new JLabel("score2");
				...
				JLabel total_score = new JLabel("T score");
				...
				JLabel player1_life1 = new JLabel(new ImageIcon("image/life_heart.png"));
				player1_life1.setBounds(20, 685, player1_life1.getIcon().getIconWidth(), player1_life1.getIcon().getIconHeight());
				add(player1_life1);
				JLabel player1_life2 = new JLabel(new ImageIcon("image/life_heart.png"));
				player1_life2.setBounds(55, 685, player1_life2.getIcon().getIconWidth(), player1_life2.getIcon().getIconHeight());
				add(player1_life2);
				JLabel player1_life3 = new JLabel(new ImageIcon("image/life_heart.png"));
				player1_life3.setBounds(90, 685, player1_life3.getIcon().getIconWidth(), player1_life3.getIcon().getIconHeight());
				add(player1_life3);
