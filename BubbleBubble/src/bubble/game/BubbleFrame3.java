...
public class BubbleFrame3 extends JFrame {
	...
	private void initObject() {
		backgroundMap = new JLabel(new ImageIcon("image/round03.png"));
		setContentPane(backgroundMap);
		player = new Player(mContext3);
		add(player);
		enemys = new ArrayList<Enemy>();
		enemys.add(new Enemy(mContext3, EnemyWay.RIGHT));
		enemys.add(new Enemy(mContext3, EnemyWay.LEFT));
